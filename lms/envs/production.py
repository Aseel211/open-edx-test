...
XBLOCK_SETTINGS.setdefault("VideoBlockurl", {})['YOUTUBE_API_KEY'] = AUTH_TOKENS.get('YOUTUBE_API_KEY', YOUTUBE_API_KEY)
...
##### Add test_api to INSTALLED_APPS  #####
INSTALLED_APPS.append('lms.djangoapps.test_api')
